...
pub async fn new_course(
    ...
    let course_count_for_user = app_state
        ...
        .count();  //usize
    let ccfu = course_count_for_user as i32; //.count is usize but course_id is Option<i32> -> has to be converted to make +1
    let new_course = Course {
        tutor_id: new_course.tutor_id,
        course_id: Some(ccfu + 1),  //Option<i32>
...
mod tests {
    ...
    async fn post_course_test() {
        let course = web::Json(Course {
            tutor_id: 1,
            course_id: None,
            course_name: "This is test course".into(),
            posted_time: None,
        });
